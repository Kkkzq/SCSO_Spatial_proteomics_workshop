...
## Step 1: Understanding Multiplexed Channels

Click on any channel name to expand the full list.

* **Task:** Count the available channels and look at the metadata (wavelengths/names).
...
## Step 2: Intensity Ranges & Bit Depth
...
:::{admonition} BONUS: Bit Depth Discovery
:class: tip
...
## Step 3: Spatial Metadata (Pixels vs. Microns)
...
:::{admonition} BONUS: Why does pixel size matter?
:class: tip
...
## Step 4: Composites & Data Integrity

1. Activate these 6 channels: **PDL1, CD8, FoxP3, CD68, CK, and DAPI**.
2. Customize the colors to create a high-contrast "Snapshot."
3. **Right-click → Save Image As** to take a snapshot of a Region of Interest (ROI).

:::{warning} Critical Thinking: The "Snapshot" Trap
